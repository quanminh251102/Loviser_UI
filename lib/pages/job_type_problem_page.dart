...
class JobTypeProblem extends StatefulWidget {
  const JobTypeProblem({Key? key}) : super(key: key);

  @override
  State<JobTypeProblem> createState() => _JobTypeProblemState();
}

class _JobTypeProblemState extends State<JobTypeProblem> {
    ...
    final PreferredSizeWidget appBar = AppBar(
        ...
        leading: Container(
          ...
          child: IconButton(
            ...
            onPressed: () {
              print('Exit Job Type Problem page');
                  ...
                  child: Column(
                    children: const <Widget>[
                      ...
                      Padding(
                        ...
                        child: Text(
                          'Bạn đang gặp vấn đề? Chọn vấn đề của bạn để được tư vấn',
                          style: TextStyle(
                      ...
                      Padding(
                        padding: EdgeInsets.symmetric(horizontal: 20),
                        child: Text(
                          'Chúng tôi dựa vào dữ liệu mà bạn cung cấp để gợi ý freelancer phù hợp với vấn đề của bạn',
                          style: TextStyle(
                              color: Color(0xFF0D0D26),
                              fontSize: 14,
